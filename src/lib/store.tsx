...
const SEED_MATERIALS: LibraryMaterial[] = [
  {
    ...
    /* 단계는 색 이름으로 부른다 (2026-08-21 리드 지시 · 학원법) — 시범 자료라 제목도 함께 고쳤다 */
    title: "천국 비유 풀이 과정 표준 강의안 활용 안내",
    body: "천국 비유 풀이 과정 23강 표준 교안의 7항목 구조(교육 핵심 / 기존 관점 / 예상 반응·질문 / 강의 주의사항 / 유도형 질문 / 예방·상담 / 교정 포인트) 활용 지침.\n\n강의 준비 시 '예상 반응·질문' 항목을 먼저 확인하고, 분반 담당 전도사와 '예방·상담' 항목을 공유한다.",
    externalUrl: null,
    isFeatured: false,
    section: "instructor",
    folderPath: ["개강 세미나"],
...
const SEED_NOTES: LessonNote[] = [
  {
    ...
    /*
      ⚠️ 강 번호 없는 표기 — 연속 번호를 뺐다(2026-08-15 리드 지시).
      ⚠️ 단계는 **색 이름**이다 — 「초등」 표기도 뺐다(2026-08-21 리드 지시 · 학원법).
    */
    lessonLabel: "천국 비유 풀이 — 두 가지 신",
    kind: "question",
